...
<main class="main-content">
    ...
    <div class="page-header">
        ...
        <div>
            @if ($errors->any())
            <div class="error-box" style="background-color: #ffe5e5;border: 1px solid #ff4d4d;color: #b30000;padding: 12px;border-radius: 8px;margin-bottom: 15px;">
        ...
        Modal.innerHTML = `
            ...
            <form action="${url}" method="post" class="product-form" id="productForm" enctype="multipart/form-data">
                ...
                <div class="modal-actions">
                    ...
                    <button type="submit" class="btn-primary">
                        <span id="submitBtnText">Update le produit</span>
                    </button>
                </div>
            </form>
        </div>
